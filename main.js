    ...
    $(".expandDetails").on("click", function () {
        ...
        var modalInfo = {
            ...
            7: {
                ...
                aboutp: "About This Project:",
                info: "This is a very simple project, that evolved from a basic terminal based password generator. From the terminal version I developed a tkinter application that provided a GUI for the application. From there I wanted to take it online, that's where Flask came in. I also wanted to have conditional formatting on the input form. The project uses a simple textbook file to store the data, not very secure at all. Going forward I want to improve the secuirty of the data and create a log-in page and separate account for each usere.",
                summary: "Summary:",
                summaryp: "This is one of my first python projects, and altough not pretty, it's a project I am proud of as it was a natural evolution of my inital, simple project. Watching this grow was, and continues to be, very satisfying. Although simple, I belieive the project caputures the functionality I was looking for, the code for the project can be found by following the GitHub button below, and you can view the live project by following the view button.",  
